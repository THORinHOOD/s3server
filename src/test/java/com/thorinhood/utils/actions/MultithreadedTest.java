...
public class MultithreadedTest extends BaseTest {
    ...
    public void putGetWhileOverwrite() throws Exception {
        ...
        String firstContent = createContent(5242880 * 2);
        String secondContent = createContent(5242880 * 3);
        ...
        putObjectRaw(s3, "bucket", "folder1/file.txt", firstContent, null);
        ...
        List<CompletableFuture<ResponseBytes<GetObjectResponse>>> getFutureList = getObjectAsync(s3Async,
                "bucket", "folder1/file.txt", null, null, 200);
        checkGetObjectAsync(getFutureList, contents, metadatas);
        checkPutObjectAsync("bucket", "folder1", "file.txt", putFutureList, contents,
                metadatas);
    }
